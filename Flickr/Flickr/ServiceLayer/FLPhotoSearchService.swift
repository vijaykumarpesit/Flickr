...
final class FLPhotoSearchService: FLPhotoSearchServiceProtocol {
    ...
    func searchPhotos(searchText: String, page: Int, perPageCount: Int, completionHandler: @escaping (FLPhotosCollection?, Error?) -> Void) {
        ...
        let endPoint:NWEndPoint = NWEndPoint.init(baseURL:self.baseURL, pathComp: self.pathComponent, method: self.httpMethod, headers:nil, params: params, body: nil)
